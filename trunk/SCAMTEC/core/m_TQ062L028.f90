...
!
    ...
    TQ062L028_struc%gridDesc( 1) = 4         !Input grid type (4=Gaussian)
    TQ062L028_struc%gridDesc( 2) = 192       !Number of points on a lat circle
    TQ062L028_struc%gridDesc( 3) = 96       !Number of points on a meridian
    TQ062L028_struc%gridDesc( 4) = 88.572  !Latitude of origin
    TQ062L028_struc%gridDesc( 5) = 0.0       !Longitude of origin
    TQ062L028_struc%gridDesc( 6) = 128       !8 bits (1 byte) related to resolution
                                        !(recall that 10000000 = 128), Table 7
    TQ062L028_struc%gridDesc( 7) = -88.572 !Latitude of extreme point
    TQ062L028_struc%gridDesc( 8) = 358.125    !Longitude of extreme point
    TQ062L028_struc%gridDesc( 9) = 1.875     !N/S direction increment
    TQ062L028_struc%gridDesc(10) = 48       !(Gaussian) # lat circles pole-equator
    TQ062L028_struc%gridDesc(20) = 0.0  
...
!
    ...
    do iv = 1, y!size(pds5)
       ...
       if (file_exists) then 
          ...
          if(iret.eq.0) then
             call getgb(lugb,lubi,TQ062L028_struc%npts,j,jpds,jgds,kf,k,kpds, &
