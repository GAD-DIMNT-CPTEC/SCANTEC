MODULE SCAM_Modelplugin
  ...
  integer, public, parameter :: AGCMId      = 1  ! AG CM/CPTEC
  integer, public, parameter :: EtaId       = 2  ! Eta/CPTEC
  integer, public, parameter :: clima50yrId = 3  ! 50yr Climatology / CPTEC
  integer, public, parameter :: bramsId     = 4  ! BRAMS/CPTEC
  integer, public, parameter :: radioId     = 5  ! radiossonda
  !-------------------------------------------------------------------
...
!    call registermodelinit(EtaId,eta_init)
	...
	! radiossonda
    	call registermodelinit(radioId,radio_init)
    	call registermodelread(radioId,radio_read)
