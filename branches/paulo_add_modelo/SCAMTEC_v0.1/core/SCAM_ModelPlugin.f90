MODULE SCAM_Modelplugin
  USE m_agcm
  USE m_clima50yr
  USE m_IWV_PSAS_T126 !Paulo Dias
  IMPLICIT NONE
  !BOP
  !
  !  !MODULE: SCAM_Modelplugin
  ...
  integer, public, parameter :: IWV_PSAS_T126Id = 4  ! IWV-PSAS T126 !Paulo Dias
...
!    call registermodelinit(EtaId,eta_init)
    ...
    ! IWV-PSAS_T126
    call registermodelinit(IWV_PSAS_T126Id,IWV_PSAS_T126_init) !Paulo Dias 
    call registermodelread(IWV_PSAS_T126Id,IWV_PSAS_T126_read)
