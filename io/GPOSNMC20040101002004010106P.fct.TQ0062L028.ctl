dset ^GPOSNMC20040101002004010106P.fct.TQ0062L028.grb
*
index ^GPOSNMC20040101002004010106P.fct.TQ0062L028.idx
*
undef -2.56E+33
*
...
tdef     1 linear 06Z01JAN2004 6hr
*
...
RNOF    0  178,    1,    0  ** sfc   RUNOFF                                  (KG/M2/S)        )
PITP    0  179,    1,    0  ** sfc   INTERCEPTION LOSS                       (W/M2            )
CSSF    0  122,    1,    0  ** sfc   SENSIBLE HEAT FLUX FROM SURFACE         (W/M2            )
CLSF    0  121,    1,    0  ** sfc   LATENT HEAT FLUX FROM SURFACE           (W/M2            )
EVAP    0   57,    1,    0  ** sfc   EVAPORATION                             (KG/M2/DAY       )
