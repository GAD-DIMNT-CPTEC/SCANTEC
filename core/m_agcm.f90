...
!
   ...
   !
    ...
    call bilinear_interp_input(agcm_struc%gridDesc, scantec%gridDesc,        &
...
!
    ...
    j    = 0
    jpds = -1 
    !          Q   Q   Q   T   T   T   T  P   A   Z   Z   Z   U   U   U   V   V   V  
    pds5 = (/ 51, 51, 51, 11, 11, 11, 11,  2, 54,  7,  7,  7, 33, 33, 33, 34, 34, 34 /) !parameter
    pds7 = (/925,850,500,925,850,500,250,000,000,850,500,250,850,500,250,850,500,250/) !htlev2

    allocate(lb2(agcm_struc%npts,scantec%nvar))
    ...
    allocate(f2(agcm_struc%npts,scantec%nvar))
    ...
    DO iv=1,scantec%nvar
       ...
       call interp_agcm( kpds, agcm_struc%npts,f2(:,iv),lb2(:,iv), scantec%gridDesc,&
...
!
    ...
    call bilinear_interp(gridDesc,ibi,lb,f,ibo,lo,field1d,   &
                         ...
                         agcm_struc%w211, agcm_struc%w221,   &
                         agcm_struc%n111, agcm_struc%n121,   &
                         agcm_struc%n211, agcm_struc%n221,scantec%udef,iret)
